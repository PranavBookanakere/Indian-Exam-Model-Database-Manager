...
SELECT * from student;
INSERT INTO PU_admission (student_id, college_id, admission_date) VALUES (3,1,CURDATE());
CALL GetStudentsByExamAndCutoff('JEE Advanced',335);
CALL GetCampusInfo("PESU");
CALL DisplayEligibleInstitutionsForStudent_University(100,'JEE Advanced',355);
